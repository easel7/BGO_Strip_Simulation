...
//
//
/// \file B4/include/CellParameterisation.hh
/// \brief Definition of the B4::CellParameterisation class

#ifndef B4CellParameterisation_H
#define B4CellParameterisation_H 1
