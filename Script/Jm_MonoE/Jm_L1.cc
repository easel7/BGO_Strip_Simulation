void Jm_L1()
{
    int p_First_Had_Layer;   int p_First_Had_Type; double p_E_total;    std::vector<double>* p_RMSVec = nullptr;    std::vector<double>* p_EnergyVec = nullptr;    std::vector<double>* p_Efrac = nullptr; std::vector<double>* p_L_EnergyVec = nullptr;
    int d_First_Had_Layer;   int d_First_Had_Type; double d_E_total;    std::vector<double>* d_RMSVec = nullptr;    std::vector<double>* d_EnergyVec = nullptr;    std::vector<double>* d_Efrac = nullptr; std::vector<double>* d_L_EnergyVec = nullptr;
    int e_First_Had_Layer;   int e_First_Had_Type; double e_E_total;    std::vector<double>* e_RMSVec = nullptr;    std::vector<double>* e_EnergyVec = nullptr;    std::vector<double>* e_Efrac = nullptr; std::vector<double>* e_L_EnergyVec = nullptr;
    int h_First_Had_Layer;   int h_First_Had_Type; double h_E_total;    std::vector<double>* h_RMSVec = nullptr;    std::vector<double>* h_EnergyVec = nullptr;    std::vector<double>* h_Efrac = nullptr; std::vector<double>* h_L_EnergyVec = nullptr;
    int H_First_Had_Layer;   int H_First_Had_Type; double H_E_total;    std::vector<double>* H_RMSVec = nullptr;    std::vector<double>* H_EnergyVec = nullptr;    std::vector<double>* H_Efrac = nullptr; std::vector<double>* H_L_EnergyVec = nullptr;
    int c_First_Had_Layer;   int c_First_Had_Type; double c_E_total;    std::vector<double>* c_RMSVec = nullptr;    std::vector<double>* c_EnergyVec = nullptr;    std::vector<double>* c_Efrac = nullptr; std::vector<double>* c_L_EnergyVec = nullptr;
    ...
    // h1_p->GetYaxis()->SetRangeUser(0,0.5);h1_p->SetTitle(Form("1000 GeV incident; log_{10}(Jm) = log_{10}(Max Energy Deposit bar in L%d/ Energy Deposit in L%d);Count",k,k));
    h1_p->GetYaxis()->SetRangeUser(0,2000);h1_p->SetTitle(Form("1000 GeV incident; log_{10}(Jm) = log_{10}(Max Energy Deposit bar in L%d/ Energy Deposit in L%d);Count",k,k));
