void Emax_Efrac()
{
    ...
    for (Long64_t entry = 0; entry < proton_tree->GetEntries(); ++entry)
    {
        ...
        h1_p[p_energy_index][p_First_Had_Layer]->Fill( log10((*p_Efrac)[p_maxIndex]) );
        h1_p_inter[p_energy_index]->Fill( log10((*p_Efrac)[p_maxIndex]) ) ;
    }
    ...
    for (Long64_t entry = 0; entry < deuteron_tree->GetEntries(); ++entry)
    {
        ...
        h1_d[d_energy_index][d_First_Had_Layer]->Fill( log10((*d_Efrac)[d_maxIndex]) );
        h1_d_inter[d_energy_index]->Fill( log10((*d_Efrac)[d_maxIndex]) ) ;
    }
