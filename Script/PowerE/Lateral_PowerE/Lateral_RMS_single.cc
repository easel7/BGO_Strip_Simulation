void Lateral_RMS_Single()
{
    ...
    h1_p->GetYaxis()->SetRangeUser(0,0.25);h1_p->SetTitleSetTitle(Form("Deposit Energy[%.2fGeV, %.2fGeV] Deposit Energy Distrubution in L%d;RMS distribution;Normalized Count", 1+0.2*k ,1.2+0.2*k ,j ));
