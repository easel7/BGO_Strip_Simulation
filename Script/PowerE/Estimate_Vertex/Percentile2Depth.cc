...
void Percentile2Depth()
{
    ...
    auto h1_p_int = new TH1D("h1_p_int","h1_p_int",30,-10,5);  
    auto h1_d_int = new TH1D("h1_d_int","h1_d_int",30,-10,5);  
    ...
    for(int i =0 ; i<15 ; i++)  // Deposit Energy Bin
    {
        ...
        h1_p_inter[i] =new TH1D(Form("h1_p_inter[%d]",i),Form("h1_p_inter[%d]",i),30,-10,5);  
        h1_d_inter[i] =new TH1D(Form("h1_d_inter[%d]",i),Form("h1_d_inter[%d]",i),30,-10,5);  
        for( int j= 0; j<14 ;j++)
        {
            h1_p[i][j] = new TH1D(Form("h1_p[%d][%d]",i,j), Form("h1_p[%d][%d]",i,j),30,-10,5);  
            h1_d[i][j] = new TH1D(Form("h1_d[%d][%d]",i,j), Form("h1_d[%d][%d]",i,j),30,-10,5);  
            Layer[j] = 0.5 + j;
            Layer_Err[j] = 0.5;
        }
        if (i<14)
        {
            h1_p_Lay[i] =new TH1D(Form("h1_p_Lay[%d]",i),Form("h1_p_Lay[%d]",i),30,-10,5);  
            h1_d_Lay[i] =new TH1D(Form("h1_d_Lay[%d]",i),Form("h1_d_Lay[%d]",i),30,-10,5);  
        }
    }
