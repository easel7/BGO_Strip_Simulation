void Longti_EnergyVec_Interaction()
{
    ...
    for (Long64_t entry = 0; entry < proton_tree->GetEntries(); ++entry)
    {
        ...
        h1_p[p_energy_index][p_First_Had_Layer]->Fill(log10((*p_EnergyVec)[p_First_Had_Layer]));
    ...
    for (Long64_t entry = 0; entry < deuteron_tree->GetEntries(); ++entry)
    {
        ...
        h1_d[d_energy_index][d_First_Had_Layer]->Fill(log10((*d_EnergyVec)[d_First_Had_Layer]));
    }
