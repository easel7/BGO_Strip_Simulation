...
void Efficiency_UBT()
{
    ...
    for (int i = 0; i < 19; i++)
    {
        ...
        for (Long64_t entry = 0; entry < proton_tree->GetEntries(); ++entry)
        {
            ...
            if((*p_EnergyVec)[0] > 0.23   && (*p_EnergyVec)[1]  > 0.23 && (*p_RMSVec)[2]<40 && (*p_RMSVec)[3]<40) h5_p[i]->Fill(p_Total_E/p_Energy);
            ...
            if((*d_EnergyVec)[0] > 0.23   && (*d_EnergyVec)[1] > 0.23 && (*d_RMSVec)[2]<40 && (*d_RMSVec)[3]<40) h5_d[i]->Fill(d_Total_E/d_Energy);
            ...
            if((*e_EnergyVec)[0] > 0.23 && (*e_EnergyVec)[1] > 0.23 && (*e_RMSVec)[2]<40 && (*e_RMSVec)[3]<40) h5_e[i]->Fill(e_Total_E/e_Energy);
            ...
            if((*h_RMSVec)[0]>15 && (*h_RMSVec)[1]>15 && (*h_RMSVec)[2]<40 && (*h_RMSVec)[3]<40) h5_h[i]->Fill(h_Total_E/h_Energy);
            ...
            if (((*H_EnergyVec)[2] > 0.0092 && (*H_EnergyVec)[10] > 0.0092 && (*H_EnergyVec)[12] > 0.0092 ) || ((*H_EnergyVec)[3] > 0.0092 && (*H_EnergyVec)[11] > 0.0092 && (*H_EnergyVec)[13] > 0.0092 )) h4_H[i]->Fill(H_Total_E/H_Energy);
            // if ((*H_RMSVec)[0]>15 && (*H_RMSVec)[1]>15) h5_H[i]->Fill(H_Total_E/H_Energy);
            if((*H_EnergyVec)[0] > 0.23 && (*H_EnergyVec)[1] > 0.23 && (*H_RMSVec)[2]<40 && (*H_RMSVec)[3]<40) h5_H[i]->Fill(H_Total_E/H_Energy);
            ...
            if((*c_EnergyVec)[0] > 0.23 && (*c_EnergyVec)[1] > 0.23 && (*c_RMSVec)[2]<40 && (*c_RMSVec)[3]<40) h5_c[i]->Fill(c_Total_E/c_Energy);
    ...
    auto gre_p_RMS = CreateGraphWithProperties(19, Energy, Proton_Eff_RMS, Energy_Err, Uncertainty, 20, kRed, kRed, "E_{0}>10 MIP && E_{1}>10 MIP && RMS_{2}<40 && RMS_{3} < 45;Kinetic Energy (GeV); Trigger Efficiency");
    ...
    auto gre_d_RMS = CreateGraphWithProperties(19, Energy, Deuteron_Eff_RMS, Energy_Err, Uncertainty, 21, kBlue, kBlue,  "E_{0}>10 MIP && E_{1}>10 MIP && RMS_{2}<40 && RMS_{3} < 45;Kinetic Energy (GeV); Trigger Efficiency");
    ...
    auto gre_e_RMS = CreateGraphWithProperties(19, Energy, Electron_Eff_RMS, Energy_Err, Uncertainty, 22, kOrange-3, kOrange-3,  "E_{0}>10 MIP && E_{1}>10 MIP && RMS_{2}<40 && RMS_{3} < 45;Kinetic Energy (GeV); Trigger Efficiency");
    ...
    auto gre_h_RMS = CreateGraphWithProperties(19, Energy, Helium4_Eff_RMS, Energy_Err, Uncertainty, 23, kGreen-3, kGreen-3, "E_{0}>10 MIP && E_{1}>10 MIP && RMS_{2}<40 && RMS_{3} < 45;Kinetic Energy (GeV); Trigger Efficiency");
    ...
    auto gre_H_RMS = CreateGraphWithProperties(19, Energy, Helium3_Eff_RMS, Energy_Err, Uncertainty, 32, kGreen-3, kGreen-3, "E_{0}>10 MIP && E_{1}>10 MIP && RMS_{2}<40 && RMS_{3} < 45;Kinetic Energy (GeV); Trigger Efficiency");
    ...
    auto gre_c_RMS = CreateGraphWithProperties(19, Energy, Carbon_Eff_RMS, Energy_Err, Uncertainty, 23, kMagenta, kMagenta, "E_{0}>10 MIP && E_{1}>10 MIP && RMS_{2}<40 && RMS_{3} < 45;Kinetic Energy (GeV); Trigger Efficiency");
