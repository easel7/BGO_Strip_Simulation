void CrossSection_Single()
{
    ...
    auto *h0 = new TH1D("h0","h0",200,0,300);     // auto *h0 = new TH1D("h0","h0",30,0,30);
    auto *h1 = new TH1D("h1","h1",200,0,300);     // auto *h1 = new TH1D("h1","h1",30,0,30);
    auto *h2 = new TH1D("h2","h2",200,0,300);     // auto *h2 = new TH1D("h2","h2",30,0,30);
    ...
    h0->SetTitle("100 GeV Proton - Electromagnetic Depth Distribution;Depth(mm);Counts");
    ...
    c1->SaveAs("/Users/xiongzheng/software/B4/B4e/Script/CrossS/CrossSection_Proton.pdf");
}