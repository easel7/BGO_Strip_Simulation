void CrossSection_Dual_Ine_Ratio()
{
    ...
    // for (int k =0; k < 28; k++)
    {
        ...
        // for (int i =0; i < 27; i++)
        {
            ...
            // Fit for Survive
            TF1 *fitFunc1 = new TF1("fitFunc1", Form("%.2f*exp(-(x+12.75)/[0])", h_p_tot->Integral()),50,300); fitFunc1->SetParameters(200); fitFunc1->SetLineColor(kRed);  
        ...
        // gre_lambda_d_int->GetYaxis()->SetRangeUser(50,300);
    ...
    // auto c5 = new TCanvas("c5","c5",2500,2500);
