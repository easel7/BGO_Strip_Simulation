void CrossSection_Dual_Ine_PowerLaw()
{
    ...
    tree_p->Draw("First_Ine_Depth>>h_p_tot","(Total_E>43 && Total_E<100)","");
    tree_p->Draw("First_Ine_Depth>>h_p_int","(Total_E>43 && Total_E<100)","");
    ...
    tree_d->Draw("First_Ine_Depth>>h_d_tot"," (Total_E>43 && Total_E<100 )","");
    tree_d->Draw("First_Ine_Depth>>h_d_int"," (Total_E>43 && Total_E<100 )","");
    ...
    // Fit for Interaction 
    TF1 *fitFunc5 = new TF1("fitFunc5", "[0]/[1]*exp(-x/[1])", 0,250); fitFunc5->SetParameters(1e5,200); fitFunc5->SetLineColor(kRed);  fitFunc5->FixParameter(0,(h_p_tot->Integral()*h_p_int->GetBinWidth(1)));
    TF1 *fitFunc6 = new TF1("fitFunc6", "[0]/[1]*exp(-x/[1])", 0,250); fitFunc6->SetParameters(1e5,200); fitFunc6->SetLineColor(kBlue); fitFunc6->FixParameter(0,(h_d_tot->Integral()*h_d_int->GetBinWidth(1)));
    ...
    TF1 *fitFunc4 = new TF1("fitFunc4", "[0]*(1-[1])/[2]*exp(-x/[2])+[0]*[1]/[3] *exp(-x/ [3] )", 0,250); fitFunc4->SetParameters(1e5, 0.5,200,170); fitFunc4->SetLineColor(kBlack); 
