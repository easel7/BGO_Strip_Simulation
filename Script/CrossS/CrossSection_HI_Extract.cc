void CrossSection_HI_Extract()
{
    ...
    for (int i =0; i < 19; i++)
    {
        ...
        c1->SaveAs( Form("/Users/xiongzheng/software/B4/B4e/Script/CrossS/CrossSection_HI_%dGeV.pdf",int(Energy[i])) );
    }
    ...
    legend2->Draw();
    c0->SaveAs("/Users/xiongzheng/software/B4/B4e/Script/CrossS/CrossSection_HI.pdf");
    ...
    c0->SaveAs("/Users/xiongzheng/software/B4/B4e/Script/CrossS/FreePath_HI.pdf");
