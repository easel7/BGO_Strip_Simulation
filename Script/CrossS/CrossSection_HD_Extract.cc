void CrossSection_HD_Extract()
{
    ...
    for (int i =0; i < 19; i++)
    {
        ...
        c1->SaveAs( Form("/Users/xiongzheng/software/B4/B4e/Script/CrossS/CrossSection_HD_%dGeV.pdf",int(Energy[i])) );
    }
    ...
    legend2->Draw();
    c0->SaveAs("/Users/xiongzheng/software/B4/B4e/Script/CrossS/CrossSection_HD.pdf");
    ...
    c0->SaveAs("/Users/xiongzheng/software/B4/B4e/Script/CrossS/FreePath_HD.pdf");
