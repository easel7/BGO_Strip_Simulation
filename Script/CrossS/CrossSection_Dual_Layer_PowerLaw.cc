void CrossSection_Dual_Layer_PowerLaw()
{

    TCut EM  = "First_Type==0";
    TCut HD  = "First_Had_Layer>=0";
    TCut EN  = "Total_E > 640 && Total_E < 1e3";
    TCut HI  = "First_Had_Layer>=0 && First_Had_Type==1 && Total_E > 640 && Total_E < 1e3";
    ...
    hC1->SetTitle("640 - 1000 GeV Deposit Energy, Inelastic Hadronic Layer Distribution;Layer;N_{survive}");
    ...
    {
        hC1->SetBinContent(ii, ( h1_0->Integral() - h1->Integral(0,ii) ) );
        hC2->SetBinContent(ii, ( h2_0->Integral() - h2->Integral(0,ii) ) );
    }
