...
void Draw_Pattern2()
{
    ...
    {   
        ...
        if (!bar_info_assigned) {
            ...
            bool success_odd = Fit1DParameter(FitAxisFunction, g_fit_bars[0], 1, 2, 19,  bar_odd, bar_odd_err);
            ...
            bool success_even = Fit1DParameter(FitAxisFunction, g_fit_bars[0], 1, 2, 19,  bar_even, bar_even_err);
        ...
        rate_max_min = MaxMinRatio(hBGO1,entry);
        seg_sum_to_peak = AccumIncreaseToPeak(hBGO2,seg_start_idx,seg_peak_idx);
        ...
        if (rate_max_min >  1e2 )
        {
            ...
            h_Ine_Reso->Fill(p_FI_Lay,abs(seg_peak_idx-1-p_FI_Lay));
        }
        ...
        if(p_FH_Type == 1)       {  string1 = "Inelastic"; 
            ...
            h_peak_had1->Fill(seg_peak_idx-1,p_FH_Lay); 
            ...
            h_peak_had2->Fill(seg_peak_idx-1,p_FH_Lay);
            ...
            h_peak_had3->Fill(seg_peak_idx-1,p_FH_Lay);
